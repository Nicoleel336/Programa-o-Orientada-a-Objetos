...
public interface InterfaceAssociacao {
	...
	// Registra a frequencia de um associado em uma reunião. Não deveria registrar participacao em reuniões acontecidas antes da sua filiação na associação.
	...
	/*Registra o pagamento de uma taxa, em uma associação, dentro uma determinada competência, para um associado. 
	 *O valor a ser pago não pode ser menor que uma parcela, embora não precise ser exatamente duas parcelas. 
	 *Uma parcela de R$20,00 por mês aceita um pagamento de R$30,00, sendo uma parcela completa e um pedaço da próxima. 
	 *Associados remidos não deveriam mais realizar pagamentos de taxas administrativas vigentes em datas antes da sua remissão, 
	 *gerando exceção de AssociadoJaRemido se houver tentativa de se pagar algo para esse caso. 
	 *Caso o valor a ser pago seja menor que o mínimo (não sendo o ultimo do ano!) ou gerando pagamento maior que a taxa anual, gerar exceção de ValorInvalido. 
